...
def determine_os_type(magic_number):
    if 'DOS' in magic_number or 'DLL' in magic_number or 'PE32' in magic_number or 'Apple Desktop Services Store' in magic_number  or 'MS-DOS' in magic_number or 'Intel 80386 COFF' in magic_number: 
        return 'Windows'
        ...
        return 'MACOS'
    elif 'C source' in magic_number  or 'C++' in magic_number:
